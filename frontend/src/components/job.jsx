...
const job = () => {
  return (
    <div className='p-5 rounded-md shadow-xl bg-white border boder-gray-100'>
        ...
        <div className='flex item-center gap-2 my-2'>
            ...
            </Avatar> {/*//still issue to be resolved */}
            </Button>
            <div>
          ...
          <div>
            ...
            <p className='tex-5m text-gray-600'>Lorem ipsum dolor sit amet, consectetur adipisicing.</p>
          </div>
